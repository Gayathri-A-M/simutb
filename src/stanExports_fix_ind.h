...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_fix_ind");
    reader.add_event(37, 35, "end", "model_fix_ind");
    return reader;
}
#include <stan_meta_header.hpp>
class model_fix_ind
  : public stan::model::model_base_crtp<model_fix_ind> {
private:
        int N;
        vector_d y;
        double L_m;
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        m = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(L_m, U_m, m);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                m = in__.scalar_lub_constrain(L_m, U_m, lp__);
            else
                m = in__.scalar_lub_constrain(L_m, U_m);
            current_statement_begin__ = 12;
            local_scalar_t__ cv;
    ...
    void write_array(RNG& base_rng__,
        ...
        double m = in__.scalar_lub_constrain(L_m, U_m);
        vars__.push_back(m);
...
typedef model_fix_ind_namespace::model_fix_ind stan_model;
#ifndef USING_R
