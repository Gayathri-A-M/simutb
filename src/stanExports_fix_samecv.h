...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_fix_samecv");
    reader.add_event(47, 45, "end", "model_fix_samecv");
    return reader;
}
#include <stan_meta_header.hpp>
class model_fix_samecv
  : public stan::model::model_base_crtp<model_fix_samecv> {
private:
        int N;
        int n_dose;
        vector_d y;
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("m", "n_dose", n_dose);
        context__.validate_dims("parameter initialization", "m", "vector_d", context__.to_vec(n_dose));
        ...
        try {
            writer__.vector_lub_unconstrain(L_m, U_m, m);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                m = in__.vector_lub_constrain(L_m, U_m, n_dose, lp__);
            else
                m = in__.vector_lub_constrain(L_m, U_m, n_dose);
            current_statement_begin__ = 14;
            local_scalar_t__ cv;
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> m = in__.vector_lub_constrain(L_m, U_m, n_dose);
        size_t m_j_1_max__ = n_dose;
        for (size_t j_1__ = 0; j_1__ < m_j_1_max__; ++j_1__) {
...
typedef model_fix_samecv_namespace::model_fix_samecv stan_model;
#ifndef USING_R
